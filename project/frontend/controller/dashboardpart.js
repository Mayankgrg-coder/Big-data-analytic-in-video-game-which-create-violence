    ...
    $.ajax({
        ...
        success: function (data) {
            $.each(data, function (index) {
                ...
                $("#partsdetails").append("<tbody><tr style'text-align:center'><td>" 
                + data[index].partsname + "</td>" 
                +'<td><img class="img-fluid" src="http://localhost:6060/parts/' 
                + data[index].partsimg + '" style="height:200px; width:200px;"></td>'
